...
helloWorld model =
    div [ class "text-xl" ]
        ...
        , div [ Aria.label "Counter", class "text-center mt-4" ]
            [ button [ Aria.label "Decrease Counter", class "btn btn-sm btn-outline m-2", onClick Decrement ] [ text "-" ]
            , text <| "Count is: " ++ String.fromInt model
            , button [ Aria.label "Increase Counter", class "btn btn-sm btn-outline m-2", onClick Increment ] [ text "+" ]
            ]
        , table [ Aria.label "Documentation Links", class "table-auto mt-4 text-left mx-auto border-separate border-spacing-2" ]
            ...
            , tr []
                [ td [ class "border border-slate-300 p-2" ]
                    [ Icon.viewIcon Icon.book ]
                , td [ class "border border-slate-300 p-2" ]
                    [ a [ class "hover:text-blue-500", href "https://daisyui.com/docs/use/" ] [ text "DaisyUI Documentation" ] ]
                ]
            ]
        ]
